...
extension AppSettingEntityQueryWhereSort
  ...
  QueryBuilder<AppSettingEntity, AppSettingEntity, QAfterWhere> anyId() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(const IdWhereClause.any());
    });
  }
...
extension AppSettingEntityQueryWhere
  ...
  QueryBuilder<AppSettingEntity, AppSettingEntity, QAfterWhereClause> idEqualTo(
    Id id,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IdWhereClause.between(lower: id, upper: id));
  ...
  QueryBuilder<AppSettingEntity, AppSettingEntity, QAfterWhereClause> idBetween(
    Id lowerId,
    Id upperId, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension AppSettingEntityQuerySortBy
  ...
  QueryBuilder<AppSettingEntity, AppSettingEntity, QAfterSortBy> sortByValue() {
    return QueryBuilder.apply(this, (query) {
...
extension AppSettingEntityQuerySortThenBy
  ...
  QueryBuilder<AppSettingEntity, AppSettingEntity, QAfterSortBy> thenById() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'id', Sort.asc);
    });
  }
  ...
  QueryBuilder<AppSettingEntity, AppSettingEntity, QAfterSortBy> thenByValue() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'value', Sort.asc);
    });
  }
...
extension AppSettingEntityQueryWhereDistinct
  ...
  QueryBuilder<AppSettingEntity, AppSettingEntity, QDistinct> distinctByValue({
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension AppSettingEntityQueryProperty
  ...
  QueryBuilder<AppSettingEntity, int, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'id');
    });
  }
  ...
  QueryBuilder<AppSettingEntity, String, QQueryOperations> valueProperty() {
    return QueryBuilder.apply(this, (query) {
